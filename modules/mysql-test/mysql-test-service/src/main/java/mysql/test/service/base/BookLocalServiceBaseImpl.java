...
package mysql.test.service.base;
...
import mysql.test.service.BookLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link mysql.test.service.impl.BookLocalServiceImpl}.
 * </p>
 *
...
public abstract class BookLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link mysql.test.service.BookLocalServiceUtil} to access the book local service.
	 */
	...
	public Book deleteBook(long id) throws PortalException {
		return bookPersistence.remove(id);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("mysql.test.model.Book",
			bookLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("mysql.test.model.Book");
	}
