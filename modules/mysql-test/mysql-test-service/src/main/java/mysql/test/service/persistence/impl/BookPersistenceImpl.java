...
package mysql.test.service.persistence.impl;
...
import mysql.test.exception.NoSuchBookException;

import mysql.test.model.Book;
import mysql.test.model.impl.BookImpl;
import mysql.test.model.impl.BookModelImpl;

import mysql.test.service.persistence.BookPersistence;
 ...
 * @see BookPersistence
 * @see mysql.test.service.persistence.BookUtil
 * @generated
 */
@ProviderType
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	 ...
	 */
	@Override
	public Book remove(long id) throws NoSuchBookException {
	 ...
	 */
	@Override
	public Book findByPrimaryKey(long id) throws NoSuchBookException {
	 ...
	 */
	@Override
	public Book fetchByPrimaryKey(long id) {
	...
	private static final String _SQL_SELECT_BOOK_WHERE_PKS_IN = "SELECT book FROM Book book WHERE id IN (";
