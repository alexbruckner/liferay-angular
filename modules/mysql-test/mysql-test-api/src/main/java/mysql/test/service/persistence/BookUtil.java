...
package mysql.test.service.persistence;
 ...
 * @see BookPersistence
 * @see mysql.test.service.persistence.impl.BookPersistenceImpl
 * @generated
 */
@ProviderType
public class BookUtil {
	...
	*/
	public static Book remove(long id)
		throws mysql.test.exception.NoSuchBookException {
	...
	* @throws NoSuchBookException if a book with the primary key could not be found
	*/
	public static Book findByPrimaryKey(long id)
		throws mysql.test.exception.NoSuchBookException {
	...
	*/
	public static Book fetchByPrimaryKey(long id) {
