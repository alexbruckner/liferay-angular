 ...
 * {@link mysql.test.service.impl.BookLocalServiceImpl} and is the
 ...
 * @see mysql.test.service.base.BookLocalServiceBaseImpl
 * @see mysql.test.service.impl.BookLocalServiceImpl
 * @generated
 */
@ProviderType
public class BookLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link mysql.test.service.impl.BookLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<mysql.test.model.Book> getBooks(int start,
		int end) {
	...
	*/
	public static mysql.test.model.Book addBook(mysql.test.model.Book book) {
	...
	* @return the new book
	*/
	public static mysql.test.model.Book createBook(long id) {
	...
	*/
	public static mysql.test.model.Book deleteBook(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteBook(id);
	}
	...
	* @return the book that was removed
	*/
	public static mysql.test.model.Book deleteBook(mysql.test.model.Book book) {
		return getService().deleteBook(book);
	}

	public static mysql.test.model.Book fetchBook(long id) {
	...
	* @throws PortalException if a book with the primary key could not be found
	*/
	public static mysql.test.model.Book getBook(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static mysql.test.model.Book updateBook(mysql.test.model.Book book) {
