...
public class BookLocalServiceWrapper implements BookLocalService,
	...
	*/
	@Override
	public java.util.List<mysql.test.model.Book> getBooks(int start, int end) {
		return _bookLocalService.getBooks(start, end);
	}

	@Override
	public java.util.List<mysql.test.model.Book> listBooks() {
		return _bookLocalService.listBooks();
	}
	...
	*/
	@Override
	public mysql.test.model.Book addBook(mysql.test.model.Book book) {
	...
	*/
	@Override
	public mysql.test.model.Book createBook(long id) {
	...
	*/
	@Override
	public mysql.test.model.Book deleteBook(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _bookLocalService.deleteBook(id);
	}
	...
	*/
	@Override
	public mysql.test.model.Book deleteBook(mysql.test.model.Book book) {
		return _bookLocalService.deleteBook(book);
	}

	@Override
	public mysql.test.model.Book fetchBook(long id) {
	...
	*/
	@Override
	public mysql.test.model.Book getBook(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public mysql.test.model.Book updateBook(mysql.test.model.Book book) {
