...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<module.project.services.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public int compareTo(module.project.services.model.Foo foo) {
	...
	*/
	...
	@Override
	public module.project.services.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public module.project.services.model.Foo toUnescapedModel() {
