...
import module.project.services.model.FooModel;
import module.project.services.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(module.project.services.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.module.project.services.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(module.project.services.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.module.project.services.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(module.project.services.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.module.project.services.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(module.project.services.service.util.ServiceProps.get(
				"lock.expiration.time.module.project.services.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("module.project.services.model.Foo");
