...
public class FooServiceHttp {
	public static module.project.services.model.Foo addFoo(
		HttpPrincipal httpPrincipal, java.lang.String field1,
		...
		try {
			...
			return (module.project.services.model.Foo)returnObj;
		}
	...
	public static java.util.List<module.project.services.model.Foo> listFoos(
		...
		try {
			MethodKey methodKey = new MethodKey(FooServiceUtil.class,
					"listFoos", _listFoosParameterTypes1);
			...
			return (java.util.List<module.project.services.model.Foo>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _listFoosParameterTypes1 = new Class[] {  };
}